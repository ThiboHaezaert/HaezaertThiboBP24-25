...
\section{\IfLanguageName{dutch}{Gekozen infrastructuur}{Chosen infrastructure}}%
...
\subsection{\IfLanguageName{dutch}{Database}{Database}}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{GPO.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{Distribution_point.png}
